...
mkdir debug
cd debug
cmake -D NO_CPPREST_SDK:BOOL=1 -D BUILD_TESTS:BOOL=0 -D gtest_force_shared_crt:BOOL=1 -DCMAKE_BUILD_TYPE=Debug -G "NMake Makefiles" ..\..\..\..
...
mkdir release
cd release
cmake -D NO_CPPREST_SDK:BOOL=1 -D BUILD_TESTS:BOOL=0 -D gtest_force_shared_crt:BOOL=1 -DCMAKE_BUILD_TYPE=Release -G "NMake Makefiles" ..\..\..\..
if %errorlevel% neq 0 exit /b %errorlevel%
nmake
if %errorlevel% neq 0 exit /b %errorlevel%
